...
## [0.29.0](https://github.com/buddhism5080/claudette/compare/v0.28.0...v0.29.0) (2026-09-15)
...
* **chat:** adopt Claude Code session titles instead of a second Haiku ([f6125a5](https://github.com/buddhism5080/claudette/commit/f6125a5b9508c30cdfad2a826767b47f0f152aee))
...
* **chat:** auto-collapse thinking when the next block arrives ([728f456](https://github.com/buddhism5080/claudette/commit/728f4560c61593211efda9f4e3d65390fae54079))
...
* **chat:** collapse finished thinking during a live turn even with Eye on ([81a75ba](https://github.com/buddhism5080/claudette/commit/81a75ba18885763629b7741e1148bf45de18dcee))
* **chat:** cut jsonl at the undone user prompt; drop rollback prelude ([34ad194](https://github.com/buddhism5080/claudette/commit/34ad19493fb3a3c132fcfb47c4d17fe2e83228d3))
* **chat:** cut rollback at the undone user prompt, not the checkpoint ([b916a57](https://github.com/buddhism5080/claudette/commit/b916a57f6eb6f51ff5d7e06a5cbcf72e1a4aa9d2))
* **chat:** do not --resume a placeholder sid after rollback ([6493d53](https://github.com/buddhism5080/claudette/commit/6493d53e645a81ce4af2a14621c6f4c3b5a54665))
* **chat:** do not autolink CJK slash compounds as POSIX paths ([96fab60](https://github.com/buddhism5080/claudette/commit/96fab602ce1f92b25333902988bc3ce458793cd2))
...
* **chat:** drop live adopt; persist the live row id ([293b677](https://github.com/buddhism5080/claudette/commit/293b67783fb2fa95ed13f6b54379d9ca2ab85d85))
...
* **chat:** isolate MCP expand, keep prior text, render live markdown ([a059bd0](https://github.com/buddhism5080/claudette/commit/a059bd04cedadd29b943cb2e0e0844edb9461b96))
* **chat:** keep attention on remaining AskUserQuestion cards ([c015ea2](https://github.com/buddhism5080/claudette/commit/c015ea2ba867c4afa240846d5c8ffc56a1f91c2e))
* **chat:** keep concurrent AskUserQuestion cards ([73f84ee](https://github.com/buddhism5080/claudette/commit/73f84ee404ffe923eb89e15dcaa41124df25ccb7))
* **chat:** keep in-turn tools above a steered user message ([2021ca8](https://github.com/buddhism5080/claudette/commit/2021ca8a7bfcf75d427d93636fcad4bc88a6ab4a))
...
* **chat:** keep live arrival order at turn end; stop dumping text ([0fc717c](https://github.com/buddhism5080/claudette/commit/0fc717c82183cff77f7161088b3dac7ab3fce355))
* **chat:** keep live thinking on the text row across tool rounds ([2023aa8](https://github.com/buddhism5080/claudette/commit/2023aa8571b152ba3e5cc338bc1f47ff7ac55493))
...
* **chat:** keep thinking collapsed; honor CLAUDE_CODE_CONTEXT_LIMIT ([615f312](https://github.com/buddhism5080/claudette/commit/615f312287ddc4941f092c209dd462642b10bd68))
* **chat:** keep thinking height; persist tools on abort ([0f34e35](https://github.com/buddhism5080/claudette/commit/0f34e35e0283895534d64d4f58e2aee9ac9f50e8))
* **chat:** keep thinking visible during tools and after drain ([9bbf846](https://github.com/buddhism5080/claudette/commit/9bbf8461e3b471a151a9ed16999b0e09f4a9320e))
* **chat:** keep tool cards as tools; checkpoint chrome at turn end ([fb90c27](https://github.com/buddhism5080/claudette/commit/fb90c279ca5b861a7806a2aaced99f864bdd865b))
* **chat:** merge consecutive live tools and MCP calls again ([e7ea4c0](https://github.com/buddhism5080/claudette/commit/e7ea4c0e5fd527d5bb60a5d78936da4392ce158b))
* **chat:** name New chat tabs from the first prompt if Haiku fails ([aded4f8](https://github.com/buddhism5080/claudette/commit/aded4f8edf651b4e10bb7877d19b29c8e576522d))
* **chat:** never --resume without a JSONL, even if turn_count &gt; 1 ([d5f3bd3](https://github.com/buddhism5080/claudette/commit/d5f3bd318dd7b37e91efcf296c06c6e5aec1a974))
* **chat:** one transcript row per API block, no prefix adopt ([6e7ee72](https://github.com/buddhism5080/claudette/commit/6e7ee72b0f0ae3a7f0632afd096c5628dd699241))
...
* **chat:** persist completed tools on tool_result ([ff9e04a](https://github.com/buddhism5080/claudette/commit/ff9e04ac6136b50f636a90207032ab97782ca01b))
* **chat:** persist thinking after the turn ends ([a781df5](https://github.com/buddhism5080/claudette/commit/a781df5535269c64e012de797ba7cccb1725a7e9))
* **chat:** persist thinking-only rows so fork and rollback share live ids ([b138479](https://github.com/buddhism5080/claudette/commit/b138479c149273fe6737602f56269fdd678cf512))
...
* **chat:** read context cap from Claude Code settings.json ([de40520](https://github.com/buddhism5080/claudette/commit/de40520ff8e355bca0a1baf617df062dfd39edcf))
...
* **chat:** render thinking, text, and tools in API arrival order ([b6d4fb9](https://github.com/buddhism5080/claudette/commit/b6d4fb9eb022eb6baff51b72721906a3d6071156))
...
* **chat:** restore checkpoint at prompt; tools hang on user ([58458a4](https://github.com/buddhism5080/claudette/commit/58458a4902d581cfaf38577809978f765e2536b1))
...
* **chat:** restore jsonl by stored byte length, no parse ([c01eafa](https://github.com/buddhism5080/claudette/commit/c01eafa1c468f1c17f57f9c600d9fbd4c02f9315))
* **chat:** rollback Claude JSONL by checkpoint byte prefix ([617f93e](https://github.com/buddhism5080/claudette/commit/617f93e82f1fc2bb8a9c7c21784ecb14e4f4b016))
...
* **chat:** show live thinking on chatMessages; stop end-of-turn reload ([91b587b](https://github.com/buddhism5080/claudette/commit/91b587bc4521893ab802ec878f11fa2cd8df6cfd))
...
* **chat:** slice live transcript on rollback instead of rebuilding it ([95ae636](https://github.com/buddhism5080/claudette/commit/95ae6365824312b849fc82b787d00dda86884cd6))
...
* **chat:** stream into chatMessages instead of a parallel live view ([c3df525](https://github.com/buddhism5080/claudette/commit/c3df525620f390d673c0547d699f05677e821520))
...
* **chat:** unstick adopt test typing so tsc -b can ship ([c907524](https://github.com/buddhism5080/claudette/commit/c9075249c46e8fdb641b7e4a40b947b0ab05509f))
...
* **tray:** unregister icon on exit so Windows does not leave a ghost ([1ac8ed5](https://github.com/buddhism5080/claudette/commit/1ac8ed57afb688fb5f5c6985a572ba4b95cdf480))
